...
public class MyListActivityAdapter extends RecyclerView.Adapter<MyListActivityAdapter.MyViewHolder>{

    private List<MyListFlat> mDatas;
    private Context mContext;
    private LayoutInflater inflater;

    public MyListActivityAdapter(Context mContext, List<MyListFlat> mDatas) {
    ...
    private void setData(MyViewHolder holder, MyListFlat flat) {
        ...
        holder.flat_item.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                longclickListener.onClick(flat);
                return true;
            }
        });
    }
