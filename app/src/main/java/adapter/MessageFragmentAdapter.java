...
public class MessageFragmentAdapter extends BaseAdapter {
    ...
    public MessageFragmentAdapter(List<ServiceUser> mData, Context mContext) {
        this.mData = mData;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        //convertview 优化
        if(convertview == null){
            convertview = mInflater.inflate(R.layout.item_serviceuser,null);
   ...
   */
    ...
    public interface OnClickListener {
        void onClick(ServiceUser user);
    }
    public void setOnItemClick( OnClickListener listenr){
