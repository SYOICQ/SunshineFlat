...
/**
 * 如果说GLSurfaceView是画布，那么仅仅有一张白纸是没用的，
 * 我们还需要一支画笔，Renderer的功能就是这里说的画笔
 */
public class LandSpace implements GLSurfaceView.Renderer {
    ...
    public LandSpace(Context context) {
